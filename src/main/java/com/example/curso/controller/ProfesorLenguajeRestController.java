...
public class ProfesorLenguajeRestController {
	...
	public ResponseEntity<?> listaLenguajesProfesor(@RequestBody ProfesorEntity profesor) {
		ProfesorEntity profesorDb = profesorService.findById(profesor.getId());
		if(profesorDb != null) {
			Collection<LenguajeEntity> listaLenguajes = profesorDb.getLenguajes();
	...
	public ResponseEntity<?> saveLenguajeProfesor(@RequestBody ProfesorLenguaje profesorLenguaje) {
		ProfesorEntity profesorDb = profesorService.findById(profesorLenguaje.getProfesor().getId());
		if(profesorDb != null) {
			LenguajeEntity lenguajeDb = lenguajeService.findLenguajeByID(profesorLenguaje.getLenguaje().getId());
